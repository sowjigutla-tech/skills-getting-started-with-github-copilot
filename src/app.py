...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim training, technique improvement, and team relay practice",
    ...
    "Art Workshop": {
        ...
        "max_participants": 18,
        "participants": ["ava@mergington.edu", "nina@mergington.edu"]
    },
    "Drama Club": {
        "description": "Rehearse scenes, improvise, and perform for school events",
    ...
    "Robotics Club": {
        "description": "Build robots, learn engineering concepts, and enter competitions",
